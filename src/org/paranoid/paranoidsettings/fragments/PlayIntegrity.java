...
public class PlayIntegrity extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        String keysList = SystemProperties.get("persist.sys.paranoid.gms.list");
            ...
            protected String doInBackground(Void... voids) {
                ...
                try {
                    ...
                    for (Map.Entry<String, String> entry : properties.entrySet()) {
                        ...
                        SystemProperties.set("persist.sys.paranoid.gms." + key, value);
                        if (keysBuilder.length() > 0) {
                            keysBuilder.append("+");
                        }
                        keysBuilder.append(key);
                    }
                    SystemProperties.set("persist.sys.paranoid.gms.list", keysBuilder.toString());
